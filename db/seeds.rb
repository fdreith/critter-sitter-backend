...
Care.create(care_type: 0, name: "Fed", details: "2 cups", pet_id: wyatt.id, user_id: frank.id)
Care.create(care_type: 0, name: "Fed", details: "2 cups", pet_id: penny.id, user_id: frank.id)
Care.create(care_type: 0, name: "Fed", details: "2 cups", pet_id: penny.id, user_id: frank.id)
Care.create(care_type: 0, name: "Walked", details: "2 miles", pet_id: willy.id, user_id: frank.id)
Care.create(care_type: 0, name: "Walked", details: "2 miles", pet_id: wyatt.id, user_id: frank.id)
Care.create(care_type: 0, name: "Walked", details: "2 miles", pet_id: penny.id, user_id: frank.id)
Care.create(care_type: 0, name: "Walked", details: "2 miles", pet_id: willy.id, user_id: frank.id)

Care.create(care_type: 1, name: "heartworm", details: "one heatworm every month", pet_id: penny.id, user_id: frank.id, date: DateTime.new(2021,1,1,3.5))
Care.create(care_type: 1, name: "heartworm", details: "one heatworm every month", pet_id: wyatt.id, user_id: mike.id, date: DateTime.new(2021,1,1,3.5))
Care.create(care_type: 1, name: "heartworm", details: "one heatworm every month", pet_id: willy.id, user_id: wendy.id, date: DateTime.new(2021,1,1,3.5))
