class Api::V1::PetsController < ApplicationController
  ...
  # GET /pets/1
  def show
    render json: PetSerializer.new(@pet, include: [:owner, :household, :events]).serializable_hash.to_json
  end
  ...
  def create
    ...
    if @pet.save
      render json: PetSerializer.new(@pet, include: [:owner, :household, :events]).serializable_hash.to_json, status: :created
    else
